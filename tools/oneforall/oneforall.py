...
import tools.oneforall.config as config
import tools.oneforall.dbexport as dbexport
...
class OneForAll(object):
    ...
    """
    def __init__(self, target, brute=False, dns=True, req=False, port=False,
                 alive=False, format=None, path=False, takeover=False):
        self.target = target
        self.brute = brute
        self.dns = dns
        self.req = req
